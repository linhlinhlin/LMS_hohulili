...
public class DataFixInitializer {
    ...
    private void fixAssignmentTypeValues() {
        ...
        try {
            ...
            updated += safeUpdate("UPDATE assignments SET assignment_type = 'FILE_SUBMISSION' WHERE LOWER(assignment_type) = 'file_submission'");
            ...
            updated += safeUpdate("UPDATE assignments SET assignment_type = 'PROGRAMMING' WHERE LOWER(assignment_type) = 'programming'");
            updated += safeUpdate("UPDATE assignments SET assignment_type = 'PROJECT' WHERE LOWER(assignment_type) = 'project'");
            
            logResult("assignment_type", updated);
        } catch (Exception e) {
