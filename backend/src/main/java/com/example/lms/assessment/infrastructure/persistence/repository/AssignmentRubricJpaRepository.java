...
public interface AssignmentRubricJpaRepository extends JpaRepository<AssignmentRubricJpaEntity, UUID> {
    ...
    List<AssignmentRubricJpaEntity> findByTeacherIdOrderByCreatedAtDesc(UUID teacherId);
    Optional<AssignmentRubricJpaEntity> findByAssignmentId(UUID assignmentId);
}
