...
public class AssignmentJpaEntity {
    ...
    public AssignmentJpaEntity(UUID id, UUID lessonId, UUID courseId, String title, String description, String instructions, AssignmentType type, AssignmentStatus status, BigDecimal maxScore, Integer passingScore, Instant dueDate, Integer maxAttempts, Boolean allowLateSubmission, Instant createdAt, Instant updatedAt) {
    ...
    public static class Builder {
        private UUID id; private UUID lessonId; private UUID courseId; private String title; private String description; private String instructions; private AssignmentType type = AssignmentType.FILE_UPLOAD; private AssignmentStatus status = AssignmentStatus.DRAFT; private BigDecimal maxScore = new BigDecimal("100"); private Integer passingScore = 60; private Instant dueDate; private Integer maxAttempts = 1; private Boolean allowLateSubmission = false; private Instant createdAt; private Instant updatedAt;
    ...
    @Column(name = "assignment_type", nullable = false, columnDefinition = "varchar(255) default 'FILE_UPLOAD'")
