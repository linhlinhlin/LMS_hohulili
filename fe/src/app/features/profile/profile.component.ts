                  ...
                  <div class="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input 
                        ...
                        [readonly]="!isEditMode()"
                        class="w-full px-4 py-3 border border-gray-800 rounded-lg focus:ring-2 focus:ring-[#0056D2] focus:border-transparent disabled:bg-gray-100"
                        name="name">
                    </div>
                    <div>
              ...
              <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="space-y-4">
                  <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-[#0056D2]">{{ stats.completedCourses }}</span>
                  </div>
                  <div class="flex justify-between">
                ...
                <div class="space-y-3">
                  <button 
                    ...
                    <div class="flex items-center">
                      <svg class="w-5 h-5 text-[#0056D2] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
