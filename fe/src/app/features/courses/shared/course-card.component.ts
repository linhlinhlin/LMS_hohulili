...
import { CourseLevel, ExtendedCourse, LEVEL_LABELS } from '../../../shared/types/course.types';
    ...
    <article class="group overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div class="p-4">
        ...
        <a [routerLink]="['/courses', course().id]">
          <h3 class="line-clamp-2 text-[15px] font-semibold leading-snug text-gray-900 transition-colors group-hover:text-[#0056D2]">
            {{ course().title }}
          </h3>
        </a>
