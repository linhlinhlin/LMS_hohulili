    ...
    <div class="h-full">
      ...
      @if (!selectedChapterId() && !selectedLessonId()) {
        <div class="bg-white shadow-sm border border-gray-200 h-full flex items-center justify-center">
          <div class="text-center p-8">
            ...
            <p class="text-gray-500 text-sm">Ch?n m?t chuong ho?c bài h?c t? sidebar bên trái</p>
          </div>
        </div>
      }
        ...
        <div class="bg-white shadow-sm border border-gray-200 overflow-y-auto h-full">
          <div class="px-6 py-4 border-b border-gray-200 flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">C?p nh?t thông tin chuong</p>
            </div>
          </div>
          <div class="p-6 space-y-6">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Tên chuong <span class="text-red-500">*</span></label>
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Mô t?</label>
            ...
            <div class="border-t border-gray-200 pt-6">
              <h3 class="font-medium text-gray-900 mb-4">Bài h?c ({{ selectedChapterLessons().length }})</h3>
              @if (selectedChapterLessons().length > 0) {
                ...
                <div class="text-center py-8 bg-gray-50 rounded-lg"><p class="text-gray-500 text-sm">Chua có bài h?c</p></div>
              }
            </div>
          </div>
      ...
      @if (selectedSectionId()) {
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-y-auto h-full">
             ...
             <div class="flex items-center gap-3">
               ...
               <div>
                 <h2 class="text-lg font-semibold text-gray-900">
                    {{ newSectionType === 'TEXT' ? 'Van b?n' : newSectionType === 'VIDEO' ? 'Video' : newSectionType === 'FILE' ? 'Tài li?u' : 'Tr?c nghi?m' }}
                 </h2>
                 <p class="text-sm text-gray-500">{{ sectionTitle || 'Chua có tiêu d?' }}</p>
               </div>
             </div>
          </div>
          ...
          <div class="p-6 space-y-6">
             <!-- Reuse Form Logic -->
             <div>
               <label class="block text-sm font-medium text-gray-700 mb-2">Tiêu d? m?c <span class="text-red-500">*</span></label>
             ...
             <div class="flex items-center gap-2">
                ...
                <label for="reqSec" class="text-sm text-gray-700 font-medium select-none cursor-pointer">B?t bu?c hoàn thành (H?c viên ph?i xem n?i dung này)</label>
             </div>
                  ...
                  <div class="editor-container-wrapper border border-gray-300 rounded-lg bg-white relative shadow-sm" [style.height.px]="editorHeight()">
                      @if (isDataLoaded()) {
                        ...
                        <div class="flex items-center justify-center h-full text-gray-400">
                          <span class="animate-pulse">Ðang t?i trình so?n th?o...</span>
                        </div>
                      }
                  </div>
               </div>
             ...
             @if (newSectionType === 'FILE') {
               <div class="space-y-4">
                 <div>
                   <label class="block text-sm font-medium text-gray-700 mb-2">Tài li?u dính kèm</label>
                   ...
                   @if (sectionFileUrl()) {
                     <div class="p-4 border border-gray-200 rounded-lg bg-gray-50">
                       @if (isPdfFile(sectionFileUrl()!)) {
                          ...
                          <p class="text-xs text-center text-gray-500 mt-2">Ðang hi?n th? ch? d? xem tru?c PDF</p>
                       } @else {
                          <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                              ...
                              <p class="text-xs text-gray-500">File tài li?u</p>
                            </div>
                      ...
                      <div class="text-center py-8 border-2 border-dashed border-gray-300 rounded-lg">
                         <p class="text-gray-500 text-sm">Chua có file nào du?c t?i lên.</p>
                      </div>
                   }
                 </div>
               </div>
             ...
             @if (newSectionType === 'QUIZ') {
                <div class="bg-indigo-50 border border-indigo-100 rounded-lg p-6 text-center">
                    ...
                    <h3 class="text-lg font-bold text-gray-800 mb-2">Qu?n lý câu h?i tr?c nghi?m</h3>
                    <p class="text-gray-600 mb-4 text-sm max-w-lg mx-auto">
                        Ð? thêm câu h?i t? ngân hàng, ch?n ng?u nhiên ho?c cài d?t th?i gian làm bài, 
                        vui lòng s? d?ng trình qu?n lý Quiz chuyên d?ng.
                    </p>
      ...
      @if (selectedLessonId() && !selectedSectionId()) {
        <div class="bg-white overflow-y-auto h-full">
          ...
          <div class="p-6 space-y-6">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Tiêu d? <span class="text-red-500">*</span></label>
              ...
              <div class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-lg border border-gray-200 p-4">
                  <div class="flex items-center justify-between mb-4">
                    <h3 class="font-medium text-gray-900">N?i dung bài h?c ({{ selectedLesson()?.sections?.length || 0 }} sections)</h3>
                  ...
                  @if (selectedLesson()?.sections?.length === 0) {
                     <div class="text-center py-6 text-gray-500 text-sm italic">
                        Chua có n?i dung. Hãy thêm Text ho?c Video.
                     </div>
                  } @else {
            ...
            @if (getLessonType(selectedLesson()) === 'QUIZ') {
              <div class="flex flex-col gap-6 animate-fade-in">
                ...
                <!-- SECTION 1: C?U HÌNH LU?T THI (SETTINGS) -->
                <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:border-purple-300 transition-colors group">
                      <div class="flex justify-between items-start mb-2">
                        <label class="text-xs font-semibold text-gray-500 uppercase">Th?i gian làm bài</label>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:border-purple-300 transition-colors group">
                      <div class="flex justify-between items-start mb-2">
                        <label class="text-xs font-semibold text-gray-500 uppercase">Ði?m d?t t?i thi?u</label>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:border-purple-300 transition-colors group">
                      <div class="flex justify-between items-start mb-2">
                        <label class="text-xs font-semibold text-gray-500 uppercase">S? l?n làm l?i</label>
                ...
                <!-- SECTION 2: QU?N LÝ CÂU H?I (QUESTIONS MANAGER) -->
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden flex flex-col h-[500px]">
                  ...
                  <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between bg-white">
                    <div>
                      ...
                      <p class="text-xs text-gray-500 mt-0.5">Qu?n lý các câu h?i cho bài ki?m tra này</p>
                    </div>
                  ...
                  <div class="flex-1 overflow-y-auto bg-gray-50/50 p-2 relative">
                    @if (quizQuestionsLoading()) {
                      <div class="absolute inset-0 flex items-center justify-center bg-white/80 z-10">
                        <div class="flex flex-col items-center gap-3">
                          ...
                          <span class="text-sm text-gray-500 font-medium">Ðang t?i d? li?u...</span>
                        </div>
                      </div>
                    } 
                    ...
                    @if (quizQuestions().length === 0) {
                      ...
                      <div class="h-full flex flex-col items-center justify-center text-center p-8">
                        ...
                        <h5 class="text-gray-900 font-medium mb-1">Chua có câu h?i nào</h5>
                        <p class="text-gray-500 text-sm max-w-xs mb-6">B?t d?u b?ng cách ch?n câu h?i t? ngân hàng ho?c t?o danh sách ng?u nhiên.</p>
                            ...
                            <div class="flex-1 min-w-0 pt-1">
                              <div class="flex items-center gap-2 mb-1.5">
                                ...
                                <span class="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded-md border"
                                  ...
                                  {{ q.difficulty === 'EASY' ? 'D?' : q.difficulty === 'MEDIUM' ? 'Trung bình' : 'Khó' }}
                                </span>
                                <!-- Type Badge (Optional) -->
                  ...
                  <div class="bg-gray-50 px-4 py-2 border-t border-gray-200 text-xs text-gray-500 flex justify-between items-center">
                    <span>T?ng th?i gian d? ki?n: {{ quizQuestions().length * 1.5 }} phút (tham kh?o)</span>
            ...
            @if (getLessonType(selectedLesson()) === 'ASSIGNMENT') {
              <div class="space-y-4">
                <div class="bg-green-50 rounded-lg p-4 border border-green-200">
                  <h4 class="font-medium text-green-900 mb-3">Thông tin bài t?p</h4>
                  <div class="space-y-4">
                    <div>
                      <label class="block text-sm font-medium text-green-700 mb-1">Mô t?</label>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <label class="block text-sm font-medium text-green-700 mb-1">Ði?m t?i da</label>
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fade-in">
      <div class="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden transform transition-all scale-100">
        <div class="p-5 border-b border-gray-100">
          <h3 class="text-lg font-bold text-gray-900">T?o câu h?i ng?u nhiên</h3>
          <p class="text-sm text-gray-500 mt-1">Ch?n gói câu h?i và s? lu?ng c?n l?y.</p>
        </div>
        
        <div class="p-5 space-y-4">
          <!-- Select Package -->
          <div>
             <label class="block text-sm font-medium text-gray-700 mb-1">Ngu?n câu h?i</label>
             <select [(ngModel)]="selectedPackageId" (change)="onRandomPackageChange()" class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-white focus:ring-2 focus:ring-purple-500">
                <option value="">-- Ch?n gói câu h?i --</option>
      ...
      <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50" (click)="showAddQuestionsModal.set(false)">
        <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl mx-4 max-h-[80vh] flex flex-col" (click)="$event.stopPropagation()">
          <div class="p-5 border-b border-gray-200 flex items-center justify-between">
            <h3 class="text-lg font-semibold text-gray-900">Thêm câu h?i t? ngân hàng</h3>
            <button (click)="showAddQuestionsModal.set(false)" class="p-1 text-gray-400 hover:text-gray-600 rounded">?</button>
          </div>
          <div class="p-5 space-y-4 overflow-y-auto flex-1">
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Ch?n gói câu h?i</label>
            ...
            @if (packageQuestions().length > 0) {
              <div class="border border-gray-200 rounded-lg overflow-hidden">
                <div class="px-4 py-3 bg-gray-50 border-b flex items-center justify-between">
                  <span class="text-sm font-medium">Danh sách câu h?i</span>
                  <div class="flex items-center gap-2">
          ...
          <div class="p-5 border-t border-gray-200 flex justify-end gap-3">
            ...
            <button (click)="addSelectedQuestionsToQuiz()" [disabled]="selectedQuestionIds().size === 0" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:opacity-50">
              Thêm {{ selectedQuestionIds().size }} câu h?i
            </button>
          </div>
        </div>
      </div>
      ...
      <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 overflow-y-auto" (click)="showSectionModal.set(false)">
        <div class="bg-white rounded-xl shadow-xl w-full max-w-4xl mx-4 my-8 flex flex-col max-h-[90vh]" (click)="$event.stopPropagation()">
          <div class="p-5 border-b border-gray-200 flex justify-between items-center">
            <h3 class="text-lg font-semibold text-gray-900">{{ editingSectionId() ? 'Ch?nh s?a Section' : 'Thêm Section M?i' }}</h3>
          ...
          <div class="p-6 space-y-6 overflow-y-auto">
             ...
             @if (newSectionType === 'FILE') {
               <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">T?i lên tài li?u <span class="text-red-500">*</span></label>
...
export class CourseCurriculumComponent {
  ...
  public editorConfig = {
    licenseKey: 'GPL',
    // [QUAN TR?NG] Ph?i n?p Plugins vào dây thì Toolbar m?i hi?n
    plugins: [
    ...
    toolbar: {
      ...
      shouldNotGroupWhenFull: true // T? d?ng gom nhóm n?u màn hình nh?
    },

    // C?u hình Font (Ðua Arial lên d?u d? làm m?c d?nh)
    fontFamily: {
      options: [
    ...
    // C?u hình ?nh (Thanh công c? khi click vào ?nh)
    image: {
      toolbar: [
        'imageTextAlternative', // Alt text
        'toggleImageCaption',   // Chú thích
        '|',
        'imageStyle:inline',    // Can dòng
        'imageStyle:block',     // Xu?ng dòng
        'imageStyle:side',      // Ð?y sang bên
        '|',
        'resizeImage'           // Kéo giãn ?nh
      ]
    },
    ...
    // Placeholder
    placeholder: 'Nh?p n?i dung bài h?c chi ti?t t?i dây (van b?n, hình ?nh, video)...'
  };
  ...
  getLessonTypeLabel(type: string): string {
    switch (type) {
      case 'LECTURE': return 'Bài gi?ng';
      case 'QUIZ': return 'Tr?c nghi?m';
      case 'ASSIGNMENT': return 'Bài t?p';
      default: return 'Bài gi?ng';
    }
  }
  ...
  async generateRandomQuestions() {
    ...
    try {
      ...
      if (!questions || questions.length === 0) {
        alert('Gói câu h?i này không có d? li?u!');
        return;
      }
      ...
      alert('Có l?i x?y ra khi t?o câu h?i ng?u nhiên.');
    } finally {
      this.quizQuestionsLoading.set(false);
    }
  }
  ...
  async deleteSection(sectionId: string) {
    if (!confirm('B?n có ch?c mu?n xóa Section này?')) return;
    this.isSaving.set(true);
    try {
  ...
  getFileNameFromUrl(url: string): string {
    if (!url) return 'T?p dính kèm';
    try {
      const urlObj = new URL(url);
      const pathname = urlObj.pathname;
      const fileName = pathname.substring(pathname.lastIndexOf('/') + 1);
      return decodeURIComponent(fileName) || 'T?p dính kèm';
    } catch {
