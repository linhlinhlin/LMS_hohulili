...
import { ChapterDraftDTO, LessonDraftDTO, CourseAuthoringService } from '../../services/course-authoring.service';
          ...
          <div class="p-5 space-y-4">
            ...
            <div>
              ...
              <div class="grid grid-cols-3 gap-2">
                <button (click)="newLessonType = 'LECTURE'"
                        class="p-3 rounded-lg border-2 transition-colors text-center"
                        [class.border-blue-500]="newLessonType === 'LECTURE'"
                        [class.bg-blue-50]="newLessonType === 'LECTURE'"
                        [class.border-gray-200]="newLessonType !== 'LECTURE'">
                  <svg class="w-5 h-5 mx-auto mb-1 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path>
                  </svg>
                  <span class="text-xs font-medium">Bài giảng</span>
                </button>
                <button (click)="newLessonType = 'QUIZ'"
                        class="p-3 rounded-lg border-2 transition-colors text-center"
                        [class.border-purple-500]="newLessonType === 'QUIZ'"
                        [class.bg-purple-50]="newLessonType === 'QUIZ'"
                        [class.border-gray-200]="newLessonType !== 'QUIZ'">
                  <svg class="w-5 h-5 mx-auto mb-1 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                  </svg>
                  <span class="text-xs font-medium">Trắc nghiệm</span>
                </button>
                <button (click)="newLessonType = 'ASSIGNMENT'"
                        class="p-3 rounded-lg border-2 transition-colors text-center"
                        [class.border-green-500]="newLessonType === 'ASSIGNMENT'"
                        [class.bg-green-50]="newLessonType === 'ASSIGNMENT'"
                        [class.border-gray-200]="newLessonType !== 'ASSIGNMENT'">
...
export class CourseEditorSidebarComponent {
    ...
    createChapter() {
        ...
        this.sectionApi.createSection(courseId, { 
    ...
    deleteChapter(chapterId: string) {
        ...
        this.sectionApi.deleteSection(chapterId).subscribe({
            next: () => {
