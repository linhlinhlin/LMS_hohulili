import { Component, inject, computed, OnInit, effect, ViewEncapsulation, ChangeDetectionStrategy } from '@angular/core';
...
export class TeacherDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Check if already loading to avoid duplicate calls
