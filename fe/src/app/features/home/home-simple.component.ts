...
@Component({
  ...
  template: `
    ...
    <!-- Stats Section -->
    <section class="py-16 bg-[#0056D2]/5">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div class="text-center">
            <div class="text-4xl font-bold text-[#0056D2] mb-2">50+</div>
            <div class="text-gray-600">Khóa học chuyên nghiệp</div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-[#0056D2] mb-2">2.500+</div>
            <div class="text-gray-600">Học viên tin tưởng</div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-[#0056D2] mb-2">25+</div>
            <div class="text-gray-600">Chuyên gia giảng dạy</div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-[#0056D2] mb-2">1.200+</div>
    ...
    <section class="py-20 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div class="text-center">
            <div class="w-16 h-16 bg-[#0056D2]/10 rounded-full flex items-center justify-center mx-auto mb-6">
