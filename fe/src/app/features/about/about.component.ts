        ...
        <div class="container mx-auto px-4">
          <div class="max-w-4xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-8">
              <div class="bg-[#0056D2]/5 p-6 rounded-lg">
                <h3 class="text-xl font-semibold text-[#004BB5] mb-4 flex items-center"><app-icon name="target" size="sm" class="text-[#0056D2] mr-1"/> Mục tiêu</h3>
        ...
        <div class="container mx-auto px-4">
          ...
          <div class="grid md:grid-cols-3 gap-8">
            <div class="text-center">
              <div class="bg-[#0056D2]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
