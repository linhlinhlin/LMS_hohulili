...
@Component({
  ...
  template: `
    <div class="w-40 bg-white shadow-lg h-full flex flex-col">
      <!-- Header -->
      ...
      <nav class="flex-1 px-4 py-6 space-y-2">
        ...
        <a routerLink="/student/grades" 
          ...
          <span class="font-medium">Điểm số</span>
        </a>
      ...
      <div class="p-4 border-t border-gray-200">
        <button (click)="logout()" 
                class="w-full flex items-center px-4 py-3 text-red-600 rounded-lg hover:bg-red-50 transition-colors group">
