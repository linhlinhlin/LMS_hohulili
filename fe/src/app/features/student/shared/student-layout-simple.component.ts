          ...
          <div class="px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
              ...
              <div class="flex items-center space-x-3">
                ...
                <!-- Modern logout button — disabled when offline (maritime PWA) -->
                <button (click)="logout()"
                  [disabled]="!authService.canLogout()"
                  [title]="authService.canLogout() ? 'Đăng xuất' : 'Không thể đăng xuất khi ngoại tuyến'"
                  class="px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg text-sm font-medium transition-all duration-200 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-red-500/20 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-red-500 disabled:hover:shadow-none">
