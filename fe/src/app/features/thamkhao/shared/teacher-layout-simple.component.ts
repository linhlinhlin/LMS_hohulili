...
import { TeacherSidebarSimpleComponent } from './teacher-sidebar-simple.component';

@Component({
  selector: 'app-teacher-layout-simple',
  imports: [CommonModule, RouterModule, RouterOutlet, TeacherSidebarSimpleComponent],
  encapsulation: ViewEncapsulation.None,
  template: `
    <div class="min-h-screen bg-gray-100 flex">
      <!-- Sidebar -->
      <div class="hidden lg:flex lg:w-64 lg:flex-col">
        <app-teacher-sidebar-simple></app-teacher-sidebar-simple>
      </div>
