    ...
    <div class="flex items-center gap-1 p-1.5 bg-white border border-gray-200 rounded-lg shadow-sm">
      ...
      <div class="flex items-center gap-1 border-r border-gray-200 pr-2 mr-1">
        <button type="button" 
                ...
                class="p-1.5 hover:bg-[#0056D2]/5 rounded text-gray-700 text-xs font-serif transition-colors" 
                title="Phân số: tử/mẫu">
          <span class="text-base">ᵃ⁄ᵦ</span>
        </button>
        <button type="button" 
                (mousedown)="onInsert($event, '\\\\sqrt[bậc]{biểu thức}')" 
                class="p-1.5 hover:bg-[#0056D2]/5 rounded text-gray-700 text-sm transition-colors" 
                title="Căn bậc n">
          √
        </button>
        <button type="button" 
                (mousedown)="onInsert($event, '^{số mũ}')" 
                class="p-1.5 hover:bg-[#0056D2]/5 rounded text-gray-700 text-xs transition-colors" 
                title="Lũy thừa">
          x²
        </button>
        <button type="button" 
      ...
      <div class="flex items-center gap-1">
        <button type="button" 
                ...
                class="p-1.5 hover:bg-[#0056D2]/5 text-[#004BB5] rounded font-serif italic transition-colors" 
