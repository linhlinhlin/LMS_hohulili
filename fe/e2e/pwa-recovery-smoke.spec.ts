...
test.describe('@smoke PWA recovery routes', () => {
  test('@smoke legacy reset-sw alias opens the repair surface', async ({ page }) => {
  ...
  test('@smoke clear-site-data route shows manual browser cleanup guidance', async ({ page }) => {
